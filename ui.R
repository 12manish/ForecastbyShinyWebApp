library(shiny)
library(shinythemes)
#Maximize size of Uploading data set 
options(shiny.maxRequestSize=100*1024^2)

shinyUI(navbarPage(
  theme = shinytheme("superhero"),
  strong("Time Series Forecasting Tool"),
  ...
  tabPanel("Read Me",
           h3(strong("About Tool")),
           br(),
           p("This App can be used as a forecasting tool to test when should a specific smoothing forecasting technique be implemented. In this tool Seven models are embeded",align="Justify"),
           p("The first part present the summary of data which show the mean,meadion, mode. We can either upload own data  inside the R . Then the user should choose the column of data frame that contains the data requiring analysis. The frequency of data and the beginning/ending periods of both fitting sample and hold out sample can be set afterward. ",align="Justify"),
           p("Then we can compare different forecasting techniques by switching to different time series algorithm panels. We can creat our own training and testing set in the data summary panel by ourself.",align="Justify"),
           
           p("In case anyone  want to upload their own data set, the suggested form of data frame is that time in the first column and observation in the second column. then the app will definitely work. ",align="Justify"),
           br(),
           ...
           a(h5("Thanks"),href="https://www.mailmunch.com/blog/wp-content/uploads/2017/03/15-Thank-You-Page-Examples.png",target="_blank")
  )
